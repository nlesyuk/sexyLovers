	...
	<form class="quiz__form">
		...
		<div class="quiz__step1" v-show="formData['1']">
			...
			<div class="quiz__cont">
				<input type="radio" name="target" id="target2" @click="nextStep('2', '1')">
				<label for="target2">
			...
			<div class="quiz__cont">
				<input type="radio" name="target" id="target4" @click="nextStep('2', '1')">
				<label for="target4">
		...
		<div class="quiz__step3" v-show="formData['3']"> 
			<div class="quiz__cont">
				...
				<label>
					<input type="checkbox" name="partner_location[]" value="2" v-model="partner_location">
					<p class="quiz__text">В одном городе</p>
				</label>
				<label>
					<input type="checkbox" name="partner_location[]" value="3" v-model="partner_location">
					<p class="quiz__text">Не имеет значения</p>
				</label>
				<label>
					<input type="checkbox" name="partner_location[]" value="4" v-model="partner_location">
					<p class="quiz__text">В радиусе 10 км</p>
				</label>
				<label>
					<input type="checkbox" name="partner_location[]" value="5" v-model="partner_location">
