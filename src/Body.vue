<template>
<main>
    <div class="container main__girl">
...
main
	width: 100%
	background: url(/src/assets/body__girl.png) no-repeat 15% center /contain
	background-color: $black
	min-height: 90vh
	position: relative
	.main__girl
		padding-left: 20%
		// background: url(/src/assets/body__girl.png) no-repeat 20% center /contain
	.main__18
		width: 70px
		height: auto
		padding: 12px 8px
